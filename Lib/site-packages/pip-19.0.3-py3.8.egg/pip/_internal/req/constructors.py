...
def parse_editable(editable_req):
    ...
    if '+' not in url:
        raise InstallationError(
            f'{editable_req} should either be a path to a local project or a VCS url beginning with svn+, git+, hg+, or bzr+'
        )
    ...
    if package_name := Link(url).egg_fragment:
...
def install_req_from_req_string(
    ...
    try:
        ...
        raise InstallationError(f"Invalid requirement: '{req}'")
