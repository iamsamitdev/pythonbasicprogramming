...
def deprecated(reason, replacement, gone_in, issue=None):
    ...
    if replacement is not None:
        message += f" A possible replacement is {replacement}."
    if issue is not None:
        url = f"https://github.com/pypa/pip/issues/{str(issue)}"
        message += f" You can find discussion regarding this at {url}."
